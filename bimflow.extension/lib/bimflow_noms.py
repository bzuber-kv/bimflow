...
(JU_Bj-Fj-1j-5j, FLOOR_3) et ne se decoupe jamais.
...
def lire(nom):
    """((zone, etage, attribut), None) ou (None, motif du refus).

    Strict : au moindre defaut il refuse. C'est ce qu'il faut a un outil qui
    ECRIT, ou qui convertit - un nom douteux ne se devine pas."""
